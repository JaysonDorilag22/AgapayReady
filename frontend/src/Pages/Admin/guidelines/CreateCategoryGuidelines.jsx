...
export default function CreateCategoryGuidelines() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/admin/guideline/category/table");
    } catch (error) {
      setLoading(false);
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-12">
              <div className="border-b border-gray-900/10 pb-12">
                <h2 className="text-base font-semibold leading-7 text-gray-900">Create Guideline Category</h2>
            ...
            <Link to="/admin/guideline/category/table" className="text-sm font-semibold leading-6 text-gray-900">Cancel</Link>
