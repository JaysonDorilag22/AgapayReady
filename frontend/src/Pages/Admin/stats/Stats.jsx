        ...
        <div className="mt-8 sm:mt-12">
          <dl className="grid grid-cols-1 text-center justify-center gap-4 sm:grid-cols-4">
            <div className="w-1/3 flex flex-col rounded-lg px-4 py-8 text-center justify-center">
              ...
              <dd className="text-4xl font-extrabold text-red-600 md:text-9xl">
                {usersCount}
              </dd>
            </div>
            
            <div className='flex flex-row w-max gap-x-24 rounded-lg shadow-lg ring-2 ring-red-600 px-8 py-16 text-center'>
