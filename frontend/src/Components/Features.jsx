...
const features = [
  {
    name: "Evacuation Guidelines",
    description:
      "Step-by-step instructions for safe evacuation during emergencies.",
    icon: FaQuestionCircle,
  },
  {
    name: "Guidelines",
    description:
      "Comprehensive guidelines to navigate various emergency scenarios, including evacuation procedures and other emergency protocols.",
    icon: FaBook,
  },
  {
